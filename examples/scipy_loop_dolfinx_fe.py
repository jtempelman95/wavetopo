...
plt.tight_layout()
plt.savefig(Path(__file__).parent / "scipy_loop_dolfinx_fe.png", dpi=130, bbox_inches="tight")
print(f"\nFinal C={C_hist[-1]:.4f}")
print(f"Saved {Path(__file__).parent / 'scipy_loop_dolfinx_fe.png'}")
