...
% ---- fonts: same contract as the paper ---------------------------------- %
% Loaded unconditionally so MiKTeX install-on-demand works; \newtxfalse to skip.
\newif\ifnewtx\newtxtrue
\ifnewtx
...
\graphicspath{{figs/}}
\input{results_macros}          % shared with the paper: numbers cannot drift
